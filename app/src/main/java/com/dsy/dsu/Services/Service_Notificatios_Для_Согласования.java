...
// TODO: 26.03.2022 запуск код только при ЗАКРЫТИЕ
    ...
    private StringBuffer МетодГлавныйМетодСменыСтатусаСогласованияЧерезСлужбу(@NonNull Intent intent) {
        ...
        try {
            int  ПубличныйidPay = bundleДляПришлиВСлужбуСогласования.getInt("ПубличныйidPay", 0);  // TODO: 24.03.2022
            String  НомерТекущегоДокумента = bundleДляПришлиВСлужбуСогласования.getString("dsu1number", "");  // TODO: 24.03.2022
    ...
    public byte[]  МетодПолучаемNewFile1CСогласованияЧерезСлужбу(@NonNull Intent intent, @NonNull Context context, ObjectMapper jsonGenerator) {
        ...
        try {
            ...
            getFileNewOt1cPayCommit =
                    new Class_Get_Json_1C(context,
                            "http://uat.dsu1.ru:55080/dds/hs/jsonto1c/listofdocuments")
